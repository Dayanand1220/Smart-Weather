...
WHY_REACT_BOOTSTRAP.md - Why we chose React + Bootstrap
...
💡 New to this? Check out GETTING_STARTED.md for a beginner-friendly guide!
...
npm run client
The backend API will run on http://localhost:3000 The React frontend will run on http://localhost:3001 (or next available port)
...
Open your browser and navigate to http://localhost:3001 (development) or http://localhost:3000 (production)
Enter a city name in the search box
Click "Search" or press Enter
View the beautiful weather card with all weather details
Toggle between dark and light themes using the theme button in the header
Your search history is automatically saved to the database
Features Showcase
